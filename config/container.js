module.exports = (container) => {
    ...
    container.add('GoogleWebSpeechService', require('../services/GoogleWebSpeechService'), ['config/googleSpeech']);
    container.add('FileUploadMulterService', require('../services/FileUploadMulterService'), ['config/fileStore']);
    container.add('FileService', require('../services/FileService'), []);
